...
-- Vygenerováno: Pon 30. říj 2017, 19:47
...
CREATE TABLE IF NOT EXISTS `ex_comment` (
  ...
  KEY `comment` (`visible`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='List of public comments on ELEXTERN page' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `ex_default` (
  ...
  PRIMARY KEY (`row_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='List of default values of tune-up factors' AUTO_INCREMENT=35 ;
...
CREATE TABLE IF NOT EXISTS `ex_item` (
  `row_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Record ID',
  ...
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last Changed',
  PRIMARY KEY (`row_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='List of items with their tooltip and units' AUTO_INCREMENT=71 ;
...
(1, 'construction_time', 'Construction Time', 'CT', 'Time before the power plant operates.', 'years', NULL, NULL, '2014-12-20 17:05:47', '2014-12-20 17:07:29'),
(2, 'capex', 'CAPEX', NULL, 'CAPital EXpenditures: Investment costs.', '€/kW', NULL, NULL, '2014-12-20 17:06:23', '2015-01-21 08:27:13'),
(3, 'capex_idr', 'CAPEX IDR', NULL, 'Assuming Investment costs are linearly spent during the power plant construction time, CAPEX IDR represents CAPEX Including Discount Rate', '€/kW', NULL, NULL, '2014-12-20 17:07:10', '2015-01-21 06:45:21'),
(4, 'grid_connection', 'Grid Connection', NULL, 'Costs for connecting the power plant to the grid.', '€/kW', NULL, NULL, '2014-12-31 01:37:43', '2014-12-31 01:37:51'),
(5, 'lifetime', 'Lifetime', 'LT', 'During which the power plant can produce electricity.', 'years', NULL, NULL, '2014-12-31 01:45:47', '2014-12-31 01:45:47'),
(6, 'opex', 'Operation OPEX%', '', 'OPeration EXpenditures. Share of CAPEX costs that are due every year for maintenance (fixed costs even without production).', '% CAPEX', NULL, NULL, '2014-12-31 01:45:47', '2015-01-21 08:27:45'),
(7, 'fuel', 'Fuel', '', 'Cost of fuel used in the power plant for producing electricity (variable cost during production only)', '', NULL, NULL, '2014-12-31 01:45:47', '2014-12-31 01:45:47'),
(8, 'capex_actual', 'Actual CAPEX', '', 'Discounted investment costs per produced MWh over the power plant lifetime and given Discount Rate and Load Factor', '', NULL, NULL, '2014-12-31 01:45:47', '2014-12-31 01:45:47'),
(9, 'opex_actual', 'Actual OPEX', '', 'Operation costs per produced MWh given Load Factor LF', '', NULL, NULL, '2014-12-31 01:45:47', '2014-12-31 01:45:47'),
(10, 'lcoe', 'Levelised Costs Of Electricity', 'LCOE', 'Levelised Costs Of Electricity', '', NULL, NULL, '2014-12-31 01:45:47', '2014-12-31 01:45:47'),
(11, 'flexibility_yield', 'Flexibility Yield', '', 'interpolated according to ELIX index (Electricity spot price for France-Germany-Austria-Switzerland market)', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(12, 'net_cost', 'Net cost', '', 'Net cost of the electricity (LCOE-Flexibility Yield)', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(13, 'impact_economic', 'Economic impact', '', 'Computes all kind of monetary losses for the local economy: Technology and/or fuel imports from abroad since they don''t benefit local population (no jobs). Also fossil fuel depletion is a loss, and future decomissionning costs are a burden for future generations.', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(14, 'impact_social', 'Social Impact', '', 'Computes all kind of health impacts (diseases and deaths) induced by air-pollution or radiations. As these problems are managed by health insurance systems and not by the first polluer, these costs must appear clearly', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(15, 'impact_environment', 'Environmental impact', '', 'Computes the ecological footprint of technologies based on Life cycle assessment: land lost per year of operation for mining and installing facilities, no man''s land from nuclear incidents, and all related expulsions. Since there is no economy without Earth, Every destroyed land destroyed its surface share on GDP.', '', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 13:48:50'),
(16, 'impact_longterm', 'Long-term Impact', '', 'Global climate change (high momentum) and nuclear waste storage (very-long timescales involved) are here considered to impact future generations in the long-term', '', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 06:52:18'),
(17, 'cost_externality', 'Externalities Costs', '', 'Total costs of externalities (not included in the LCOE but paid by the society or impacting future generations)', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(18, 'cost_reference', 'Reference Costs', '', 'Total electricity costs (LCOE+externalities)', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(19, 'dispatchability', 'Yield-Dispatchable source?', '', 'If the power technology can be activated "on demand" or not, and at which frequency, 1-Annual, 2-Daily', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(20, 'impact_economic_decomissioning', 'Decomissionning', '', 'Costs for dismantling the plant after operation', '% CAPEX', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:02'),
(21, 'impact_economic_decomissioning_actual', 'Actual Decomissioning costs', '', 'Net to present value of costs required to dismantle the plant after operation', '€', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:04'),
(22, 'impact_economic_foreign_purchases', 'Share of foreign purchases', '', 'Share of CAPEX that does not benefit the local economy', '% CAPEX', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:07'),
(23, 'impact_economic_technology', 'Actual Technology imports', '', 'Total value of imports not benefiting the local economy', '€', NULL, NULL, '2014-12-31 01:45:48', '2015-06-26 16:28:33'),
(24, 'efficiency', 'Efficiency', '', 'Efficiency of the power plant, needed to compute the Fuel costs for Thermal power plants', '', NULL, NULL, '2014-12-31 01:45:48', '2015-06-26 16:23:19'),
(25, 'impact_economic_fossil', 'Fossil Fuel?', '', 'Total value of depleted domestic fossil fuels no longer valuable for future generations', '', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 06:56:14'),
(26, 'impact_social_sick_leaves', 'Sick leaves', '', 'Lost working days', 'Days', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:20'),
(27, 'impact_social_respiratory', 'Respiratory Diseases', '', 'Respiratory diseases due to air pollution from burning fuels', 'Diseases', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:23'),
(28, 'impact_social_cancer', 'Cancers', '', 'Cancers due to irradiation from nuclear materials manipulation incidents', 'Cancers', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:26'),
(29, 'impact_social_mortality', 'Mortality', '', 'Average deaths per use of Technology (any cause)', 'Deaths', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:28'),
(30, 'impact_environment_extended_land_use', 'Extended Land Use', '', 'Extended land use for the installations and upstream activities (mining) leading to loss of biodiversity and the free services offered by nature', 'm2*yr', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 06:58:36'),
(31, 'impact_environment_expulsion', 'Compensations for Expulsions', '', 'In case of not-planned evacuation (Nuclear incident) compensations are due to expelled people for their new accomodation', 'people', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 06:58:13'),
(32, 'impact_longterm_nuclear_waste', 'Nuclear Wastes Treatment', '', 'in % of fuel pre-treatment per year. Indeed post treatment of nuclear wastes will require day-to-day cares similar to initial fuel processing for more than centuries', '', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:38'),
(33, 'impact_longterm_climate_change', 'Climate Change start ST / cost', '', 'When do we expect climate change impacts to signigicantly affect our lifes / in World GDP% per year. Indeed climate change adaptation will be a day-to-day fight that will cost the global economy some %GDP every year and last for more than centuries', '', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 07:00:19'),
(34, 'impact_longterm_co2', 'CO2eq emissions', '', 'Average CO2 emissions per MWh due to fossil fuel burning and construction works', 't', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:47:46'),
(35, 'co2_cost', 'CO2 yearly costs, CAPEX% (vs OPEX%)', '', 'Indeed climate change adaptation will be a day-to-day fight that will cost the global economy some %GDP every year and last for more than centuries', '€/t/year', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(36, 'marginal_costs', 'Marginal Costs', '', '', '€/MWh', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(37, 'load_factor', 'Load Factor', 'LF', 'Represents the ratio of the produced electricity by its potential, were the technology be used at its nominal power during the whole year. It is lower than 100% for the following reasons:- maintenance works during which the power plant does not produce- decrease of the production to adapt to low demand- non-availability of renewable sources (absence of light or wind)', '%', NULL, NULL, '2014-12-31 01:45:48', '2015-01-21 07:08:36'),
(38, 'installed_capacity', 'Installed Capacity', '', '', 'MW', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(39, 'produced_energy', 'Produced Energy', '', '', 'MW/year', NULL, NULL, '2014-12-31 01:45:48', '2014-12-31 01:45:48'),
(40, 'discount_rate', 'Discrount Rate', 'R', 'Represents the "preference for present". = Return on investments for a company. = Interest rate for a Bank. = GDP growth for a country', '%', 'fa-line-chart', NULL, '2014-12-31 17:36:27', '2015-01-21 07:02:15'),
(41, 'time_horizon', 'Time Horizon', 'TH', 'Up to which extent shall we be neutral (responsible) for future generations concerning our todays'' energy choices. ', NULL, 'fa-clock-o', NULL, '2014-12-31 17:38:30', '2014-12-31 17:38:30'),
(42, 'world_gdp', 'World GDP', NULL, NULL, 'G€', NULL, NULL, '2015-02-02 07:49:02', '2015-02-02 07:49:02'),
(43, 'inhabitable_surface', 'Inhabitable Surface', NULL, '', 'Mkm2', NULL, NULL, '2015-02-02 07:49:48', '2015-02-02 07:49:48'),
(44, 'carbon_budget', 'Carbon budget', NULL, '', 'GtCO2', NULL, NULL, '2015-02-02 07:57:01', '2015-02-02 07:57:01'),
(45, 'tab_main', '', NULL, NULL, NULL, NULL, NULL, '2015-06-26 14:52:06', '2015-06-26 16:01:43'),
(46, 'tab_technology', '', NULL, NULL, NULL, NULL, NULL, '2015-06-26 14:52:19', '2015-06-26 16:01:44'),
(48, 'impact_longterm_adaptation', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:00:22', '2015-06-26 16:00:22'),
(49, 'impact_longterm_carbon_budget', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:00:36', '2015-06-26 16:01:39'),
(50, 'implicit_co2_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:02:32', '2015-06-26 16:02:32'),
(51, 'implicit_nuclear_waste_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:02:49', '2015-06-26 16:02:49'),
(52, 'btn_advanced', 'Advanced Mode', NULL, 'Would you like to have some more options? Try advanced mode.', NULL, NULL, NULL, '2015-06-26 16:04:54', '2015-06-26 16:06:15'),
(53, 'btn_basic', 'Basic Mode', NULL, 'Do you consider advanced mode too confusing? It''s fine, you can switch to basic mode.', NULL, NULL, NULL, '2015-06-26 16:05:01', '2015-06-26 16:07:48'),
(54, 'btn_default_value', 'Reset to Default Values', NULL, 'When your values become mess, this resets all of them to default ones.', NULL, NULL, NULL, '2015-06-26 16:05:11', '2015-06-26 16:08:19'),
(55, 'btn_logout', 'Log out of ELEXTERN', NULL, 'Oh, okay... bye.', NULL, NULL, NULL, '2015-06-26 16:05:18', '2015-06-26 16:09:00'),
(56, 'btn_gdrive', 'ELEXTERN @ Google Drive', NULL, 'Don''t worry, admin only :)', NULL, NULL, NULL, '2015-06-26 16:08:39', '2015-06-26 16:08:39'),
(58, 'country_data', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:14:36', '2015-06-26 16:15:04'),
(60, 'implicit_nuclear_fuel_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:22:01', '2015-06-26 16:22:01'),
(61, 'implicit_land_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:22:09', '2015-06-26 16:22:09'),
(62, 'impact_environment_conflict_of_use', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:26:17', '2015-06-26 16:26:17'),
(63, 'impact_economic_flexibility_yield', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:29:28', '2015-06-26 16:29:28'),
(64, 'explicit_nuclear_waste_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:39:54', '2015-06-26 16:39:54'),
(65, 'fuel_lignite_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:43:32', '2015-06-26 16:43:32'),
(66, 'explicit_nuclear_fuel_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:44:33', '2015-06-26 16:44:33'),
(67, 'fuel_coal_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:44:40', '2015-06-26 16:44:40'),
(68, 'fuel_gas_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:44:54', '2015-06-26 16:44:54'),
(69, 'fuel_oil_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:45:05', '2015-06-26 16:45:05'),
(70, 'explicit_land_price', NULL, NULL, NULL, NULL, NULL, NULL, '2015-06-26 16:46:46', '2015-06-26 16:46:46');
...
CREATE TABLE IF NOT EXISTS `ex_source` (
  `source_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Source ID',
  ...
  KEY `order` (`show_order`),
  KEY `visible` (`visible`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='List of literatures sources of data' AUTO_INCREMENT=16 ;
...
CREATE TABLE IF NOT EXISTS `ex_tech` (
  ...
  KEY `efficiency` (`eco_efficiency`),
  KEY `opex` (`opex`),
  KEY `technology_id` (`model`),
  KEY `row_id` (`row_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='List of electrict technologies for website' AUTO_INCREMENT=19 ;
...
CREATE TABLE IF NOT EXISTS `ex_user` (
  ...
  `org` varchar(512) COLLATE utf8_czech_ci DEFAULT NULL COMMENT 'Institution',
  ...
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last changed',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='List of user accounts' AUTO_INCREMENT=15 ;

--
-- Vypisuji data pro tabulku `ex_user`
--

INSERT INTO `ex_user` (`user_id`, `email`, `password`, `name`, `org`, `reason`, `last_visit`, `last_ip`, `last_user_agent`, `note`, `admin`, `visible`, `added`, `timestamp`) VALUES
(3, 'jakub.rychecky@cvrez.cz', '$2y$10$q/I4bXSP.8U2Vn.ZOvf69uESdfSNg3QhAHy9WCK9crMlgF/AKOLIa', 'Jakub Rychecky', 'Centrum vyzkumu Rez', 'Web development.', '2016-05-11 12:35:09', '193.84.170.170', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.94 Safari/537.36', NULL, 1, 1, '2015-01-31 01:52:05', '2016-05-11 10:35:09'),
(4, 'frederic.wertz@cvrez.cz', '$2y$10$ydufMYb6VKNkNPEbE4uVkOyL0iTa8OmpxB.GbdmnAiliBTjr8ulOy', 'Frédéric Wertz', 'CVR', 'F..k, you know who I am???', '2015-08-24 20:40:47', '89.235.56.153', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:40.0) Gecko/20100101 Firefox/40.0', NULL, 1, 1, '2015-01-31 16:36:53', '2015-08-24 18:40:47'),
(5, 'frederic.wertz@gmail.com', '$2y$10$fsx8cBKON.DOmCiG5mwU9uTW7O9Om.O6jIDaLTj6zykVGgMN9ceIq', 'Frédéric Wertz', 'Self employed', 'FW', '2016-11-30 18:59:06', '89.111.77.141', 'Mozilla/5.0 (Windows NT 6.1; rv:46.0) Gecko/20100101 Firefox/46.0', NULL, 0, 1, '2015-05-25 09:23:48', '2016-11-30 17:59:06'),
(8, 'jvavra@ef.jcu.cz', '$2y$10$hcsYMKIQtdYPfjuGWA00ce3t3tXoKr8QjWE4jqkoFfp0EG5vRUXC2', 'Jan Vávra', 'University of South Bohemia', 'Interesting data and comparisons for my future research and teaching in socio-environmental issues.', '2015-06-18 00:42:23', '85.207.18.54', 'Mozilla/5.0 (Windows NT 6.1; rv:38.0) Gecko/20100101 Firefox/38.0', NULL, 0, 1, '2015-06-17 22:42:07', '2015-06-17 22:42:23'),
(9, 'Artur.Linhart@centrum.cz', '$2y$10$2W71mVRpEa7Tun63od8Z1.U/EunDsurUnRoFAHT0mGp7zJ0fT//Aa', 'Artur Linhart', 'SZ', 'Informations for thinking.', '2015-10-14 10:04:00', '185.112.167.63', 'Mozilla/5.0 (X11; Linux x86_64; rv:38.0) Gecko/20100101 Firefox/38.0 Iceweasel/38.3.0', NULL, 0, 1, '2015-09-23 04:02:28', '2015-10-14 08:04:00'),
(10, 'pospisil.on@gmail.com', '$2y$10$IpgTVEU.N7D9cY2hslDIz.A7yfDgj./gwe.cfOnBpabweEqlfrSEi', 'Ondřej Pospíšil', 'Unicorn', '', '2015-11-09 11:53:38', '91.139.0.66', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36 OPR/33.0.1990.58', NULL, 0, 1, '2015-11-09 10:50:28', '2015-11-09 10:53:38'),
(14, 'lucie.nenadalova@cvrez.cz', '$2y$10$Q4f5ijU89dCFOks1xwdqtO24dZWimotSbIDqS2FVP2KuLfkdZ6l8m', 'Lucie Karásková Nenadálová', 'Centrum výzkumu Řež', '', '0000-00-00 00:00:00', '', '', NULL, 0, 1, '2016-06-22 10:48:04', '2017-08-15 14:19:28');
...
CREATE TABLE IF NOT EXISTS `ex_yield` (
  ...
  PRIMARY KEY (`row_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Yield table' AUTO_INCREMENT=13 ;
